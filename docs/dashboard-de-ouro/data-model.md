...
## Estado atual (D1, migrações 0001–0012)
...
- `tasks` e `decisions` são sempre agregadas por cliente: não representam CRM, Kanban ou atividades por lead. Decisões guardam a foto das métricas no momento do registro e comparam depois apenas a variação observada.
